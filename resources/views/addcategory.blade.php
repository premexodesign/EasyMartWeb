        ...
        <div id="box" style="margin-top:20ex; margin-left: 28ex; width: 100ex; " class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info">
                    ...
                    <div style="padding-top:30px; " class="panel-body" >
                        ...
                        <form  method="POST" action="{{ route('item.store') }}" class="form-horizontal" >
                                @CSRF    
                            <div style="margin-bottom: 25px " class="input-group">

                               <label style="position: relative; top: 30px;">Category Name: </label><input style="margin-left:20ex ;" type="text" class="form-control" name="categoryname" >                                        
                                 </div>
